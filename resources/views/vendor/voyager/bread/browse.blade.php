                            ...
                            <form method="get">
                                <div id="search-input">
                                    ...
                                    <div class="input-group col-md-12">
                                        <input type="text" class="form-control" placeholder="Поиск по строке" name="s" value="{{ $search->value }}">
                                    ...
                                    <tr>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            <td>
                                                ...
                                                @elseif($row->type == 'text')
                                                    ...
                                                    <div class="readmore">
	                                                    @if($row->field == "mobile" || $row->field == "email")
	                                                    	<nobr>{{ $data->{$row->field} }}</nobr>
	                                                    @else
                                                ...
                                                @elseif($row->type == 'file' && !empty($data->{$row->field}) )
                                                    ...
                                                    @else
                                                        <a href="{{ Storage::disk(config('voyager.storage.disk'))->url($data->{$row->field}) }}" target="_blank">
	                                                        <img src="{{ Storage::disk(config('voyager.storage.disk'))->url($data->{$row->field}) }}" width="120" />
                                                        </a>
                                                    @endif
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            @can('delete', $data)
                                                ...
                                                <a href="javascript:;" title="{{ __('voyager.generic.delete') }}" class="btn btn-sm btn-danger  delete" data-id="{{ $data->{$data->getKeyName()} }}" id="delete-{{ $data->{$data->getKeyName()} }}">
                                            ...
                                            @can('edit', $data)
                                            	<div class="text-center">
                                                <a href="{{ route('voyager.'.$dataType->slug.'.edit', $data->{$data->getKeyName()}) }}" title="{{ __('voyager.generic.edit') }}" class="btn btn-sm btn-primary  edit">
                                            ...
                                            @can('read', $data)
                                            	<div class="text-center">
                                                <a href="{{ route('voyager.'.$dataType->slug.'.show', $data->{$data->getKeyName()}) }}" title="{{ __('voyager.generic.view') }}" class="btn btn-sm btn-warning ">
